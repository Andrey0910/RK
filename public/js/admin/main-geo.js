...
/***/ (function (module, exports, __webpack_require__) {
      ...
      module.exports = function () {
        function _class() {
          ...
          this.count = document.querySelector('#markers-count');
        }
        ...
        _createClass(_class, [{
          ...
          key: 'initEvents',
          value: function initEvents(map) {
            var _this = this;

            this.map.events.add('click', function (e) {
              if (_this.map.getZoom() > 16) _this.hendlerClickMap(e);
            });
          ...
          key: 'hendlerClickMap',
          value: function hendlerClickMap(e) {
            if (+this.count.textContent === 0) return;
            this.coords = e.get('coords');

            this.showPopup('#popup-map', 'map');
          }
        }, {
          key: 'showPopup',
          value: function showPopup(selector, target) {

            switch (target) {
              case 'map':
                document.querySelector('#map-form').onsubmit = this.addMarker.bind(this);
                break;
            }

            document.querySelector('#overlay').className += ' popup-overlay_active';
            document.querySelector(selector).className += ' popup_active';
          }
        }, {
          key: 'addMarker',
          value: function addMarker(event) {
            ...
            var typeMarkers = event.target.querySelectorAll('input[type="radio"]');
            var descFile_1 = event.target.querySelector('input[name="photo-desc_1"]').value;
            var descFile_2 = event.target.querySelector('input[name="photo-desc_2"]').value;

            var files = {
              files: [{}, {}]
            };

            files.files[0].desc = descFile_1;
            files.files[1].desc = descFile_2;
            files.title = title;

            for (var i = 0; i < typeMarkers.length; i++) {
              if (typeMarkers[i].checked) selectedMarker = typeMarkers[i].value;
            }

            switch (selectedMarker) {
              case 'green':
                newPlacemark = new ymaps.Placemark(this.coords, {
                  balloonContent: balloon(files)
                }, {
                    iconLayout: 'default#image',
                    iconImageHref: './img/green-geo.svg',
                    iconImageSize: [22, 22]
                  });

                this.clusterGreen.add(newPlacemark);
                this.count.textContent = +this.count.textContent - 1;
                this.clusterGreen.events.add('balloonopen', this.initEventsBalloon.bind(this));
                break;
              case 'red':
                newPlacemark = new ymaps.Placemark(this.coords, {
                  balloonContent: balloon(files)
                    ...
                    iconLayout: 'default#image',
                    iconImageHref: './img/red-geo.svg',
                    iconImageSize: [22, 22]

                  });

                this.clusterRed.add(newPlacemark);
                this.count.textContent = +this.count.textContent - 1;
                this.clusterRed.events.add('balloonopen', this.initEventsBalloon.bind(this));
              ...
              case 'perple':
                newPlacemark = new ymaps.Placemark(this.coords, {
                  balloonContent: balloon(files)
                    ...
                    iconLayout: 'default#image',
                    iconImageHref: './img/perple-geo.svg',
                    iconImageSize: [22, 22]
                  });

                this.clusterPerple.add(newPlacemark);
                this.count.textContent = +this.count.textContent - 1;
                this.clusterPerple.events.add('balloonopen', this.initEventsBalloon.bind(this));
          ...
          key: 'editMarker',
          value: function editMarker(e, data, mark) {
            var target = e.get('target');

            target.properties.set({
              balloonContent: balloon(data)
            });

            target.options.set('iconImageHref', './img/' + mark + '-geo.svg');

            console.log(e.get('target'));

            if (this.clusterGreen.getObjectState(target).isShown) {
              this.clusterGreen.remove(target);
            } else if (this.clusterRed.getObjectState(target).isShown) {
              this.clusterRed.remove(target);
            } else if (this.clusterPerple.getObjectState(target).isShown) {
              this.clusterPerple.remove(target);
            }

            this['cluster' + (mark.charAt(0).toUpperCase() + mark.substr(1))].add(target);
            this['cluster' + (mark.charAt(0).toUpperCase() + mark.substr(1))].events.add('balloonopen', this.initEventsBalloon.bind(this));
          }
        }, {
          key: 'initEventsBalloon',
          value: function initEventsBalloon(e) {
            var _this2 = this;
            ...
            document.querySelector('#edit-button').addEventListener('click', function () {
              ...
              document.querySelector('#edit-form').onsubmit = function (event) {
                ...
                _this2.editMarker(e, files, selectedMarker);
                _this2.closePopup(event.target);
              };
            });

            document.querySelector('#remove-button').onclick = function (event) {
              event.preventDefault();
              var geoObj = e.get('target');

              if (_this2.clusterGreen.getObjectState(geoObj).isShown) {
                _this2.clusterGreen.remove(geoObj);
                count.textContent = +count.textContent + 1;
              } else if (_this2.clusterRed.getObjectState(geoObj).isShown) {
                _this2.clusterRed.remove(geoObj);
                count.textContent = +count.textContent + 1;
              } else if (_this2.clusterPerple.getObjectState(geoObj).isShown) {
                _this2.clusterPerple.remove(geoObj);
                count.textContent = +count.textContent + 1;
              }

              _this2.closePopup(document.querySelector('#edit-form'));
            };
          }
        }, {
          key: 'closePopup',
          value: function closePopup(form) {
            var nameFile = form.querySelectorAll('.form-map__file-name');
            form.parentNode.className = 'popup';
            form.parentNode.parentNode.className = 'popup-overlay';
            form.reset();

            for (var i = 0; i < nameFile.length; i++) {
              nameFile[i].textContent = 'Файл не выбран';
              nameFile[i].style.color = '#c03411';
            }

            document.querySelector('.form-map__row_hidden').style.display = 'none';
          }
        }]);
...
/***/ (function (module, exports, __webpack_require__) {
      ...
      module.exports = function () {
        ...
        var fileForm = document.querySelector('#map-form');
        ...
        overlay.addEventListener('click', function (event) {
          if (event.target.className === 'popup__close') {
            var nameFile = fileForm.querySelectorAll('.form-map__file-name');
        ...
        var handlerChange = function handlerChange(event) {
          ...
          if (target.tagName === 'INPUT' && target.type === 'file') {
            ...
            var nextItem = target.parentNode.parentNode.nextElementSibling;
            var nextInput = void 0;

            if (nextItem) nextInput = nextItem.querySelector('input[type="file"]');

            injectNameFile(target);

            if (nextInput) nextItem.style.display = 'block';
          }
        };

        fileForm.addEventListener('change', handlerChange);
        EditForm.addEventListener('change', handlerChange);
      }();
...
/***/ (function (module, exports, __webpack_require__) {
      ...
      ymaps.ready(apiYandexMap.init.bind(apiYandexMap, [61.227036, 102.342258]));
...
/******/]);
//# sourceMappingURL=data:application/json;charset=utf-8;base64,